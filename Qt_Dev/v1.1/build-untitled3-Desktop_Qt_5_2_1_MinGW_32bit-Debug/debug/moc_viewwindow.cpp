...
#include "../../untitled3/viewwindow.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_ViewWindow_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 39, 3)
    ...
    "ViewWindow\0showWhichRowSwitchOn\0\0index\0"
    "djd\0"
};
...
void ViewWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->showWhichRowSwitchOn((*reinterpret_cast< const QModelIndex(*)>(_a[1]))); break;
        case 1: _t->djd(); break;
        default: ;
        }
    }
...
const QMetaObject ViewWindow::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ViewWindow.data,
      qt_meta_data_ViewWindow,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ViewWindow.stringdata))
