...
#include "../../untitled3/checkboxdelegate.h"
...
QT_MOC_LITERAL(4, 43, 3)
    ...
    "CheckBoxDelegate\0currentRowSwitchOn\0"
    "\0index\0ads\0"
};
...
void CheckBoxDelegate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->currentRowSwitchOn((*reinterpret_cast< const QModelIndex(*)>(_a[1]))); break;
        case 1: _t->ads(); break;
        default: ;
        }
        ...
        {
            typedef void (CheckBoxDelegate::*_t)(const QModelIndex & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CheckBoxDelegate::currentRowSwitchOn)) {
                *result = 0;
            }
        }
        {
            typedef void (CheckBoxDelegate::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CheckBoxDelegate::ads)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 0
void CheckBoxDelegate::currentRowSwitchOn(const QModelIndex & _t1)
{
