...
public:
    ...
    void setupUi(QDialog *popupPage)
    {
        ...
        frame = new QFrame(popupPage);
        frame->setObjectName(QStringLiteral("frame"));
        frame->setGeometry(QRect(-10, -10, 521, 371));
        frame->setStyleSheet(QStringLiteral("background-image: url(:/image/background1.jpg);"));
        frame->setFrameShape(QFrame::StyledPanel);
        frame->setFrameShadow(QFrame::Raised);
        pushButton_placedNext = new QPushButton(frame);
        pushButton_placedNext->setObjectName(QStringLiteral("pushButton_placedNext"));
        pushButton_placedNext->setGeometry(QRect(360, 270, 101, 31));
        pushButton_jumpThisOption = new QPushButton(frame);
        pushButton_jumpThisOption->setObjectName(QStringLiteral("pushButton_jumpThisOption"));
        pushButton_jumpThisOption->setGeometry(QRect(270, 270, 81, 31));
        pushButton_backPreviousOption = new QPushButton(frame);
        pushButton_backPreviousOption->setObjectName(QStringLiteral("pushButton_backPreviousOption"));
        pushButton_backPreviousOption->setGeometry(QRect(180, 270, 81, 31));
        pushButton = new QPushButton(frame);
        pushButton->setObjectName(QStringLiteral("pushButton"));
        pushButton->setGeometry(QRect(430, 330, 75, 23));
        frame->raise();
        label->raise();
        label_2->raise();
        label_3->raise();
        textBrowser_showReagentName->raise();
        textBrowser_showReagentVolume->raise();
        textBrowser_showReagentlocation->raise();
