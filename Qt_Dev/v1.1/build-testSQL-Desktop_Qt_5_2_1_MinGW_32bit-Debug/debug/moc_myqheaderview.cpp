...
#include "../../testSQL/myqheaderview.h"
...
QT_MOC_LITERAL(4, 34, 14)
    ...
    "MyQHeaderView\0stateChanged\0\0state\0"
    "onStateChanged\0"
};
...
void MyQHeaderView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyQHeaderView::stateChanged)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void MyQHeaderView::stateChanged(int _t1)
{
