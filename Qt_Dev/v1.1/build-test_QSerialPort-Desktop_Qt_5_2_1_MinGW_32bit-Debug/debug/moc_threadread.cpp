...
#include "../../QSerialPort_0825/threadread.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_ThreadRead_t, stringdata) + ofs \
...
const QMetaObject ThreadRead::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_ThreadRead.data,
      qt_meta_data_ThreadRead,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ThreadRead.stringdata))
