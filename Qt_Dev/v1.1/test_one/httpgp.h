...
public:
    ...
    //封装JSON信息
    //  5：分配位置 6：入柜完成上报 7：取完成上报 8：还上报 9：报废 10：替换 11：登入 12:点验 13：报警
...
private:
    ...
    struct Http_info
    {
        ...
        int model_json;
        int tableNo;
        int taskRole;//1 ：入柜 2：取用 3：归还 4：替换 5：报废 6：点验 7：任务
        int allTaskCount;
    ...
    void JuageOperatorStatus(QString name);
    //判断是否完成任务
    //-1：网络错误 0：任务完成 1 ：入柜 2：取用 3：归还 4：替换 5：报废 6：点验 7：任务
    void HttpInit(void);
    //初始化
