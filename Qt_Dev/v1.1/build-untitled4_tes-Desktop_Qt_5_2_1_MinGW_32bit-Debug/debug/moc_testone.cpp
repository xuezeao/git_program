...
#include "../../untitled4_tes/testone.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_testone_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 14, 21)
    ...
    "testone\0aaaa\0\0on_pushButton_clicked\0"
};
...
void testone::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        testone *_t = static_cast<testone *>(_o);
        switch (_id) {
        case 0: _t->aaaa(); break;
        ...
        {
            typedef void (testone::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&testone::aaaa)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject testone::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_testone.data,
      qt_meta_data_testone,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_testone.stringdata))
        return static_cast<void*>(const_cast< testone*>(this));
