...
QT_MOC_LITERAL(3, 11, 21)
    },
    "test2\0sss\0\0on_pushButton_clicked\0"
};
...
void test2::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (test2::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&test2::sss)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject test2::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_test2.data,
