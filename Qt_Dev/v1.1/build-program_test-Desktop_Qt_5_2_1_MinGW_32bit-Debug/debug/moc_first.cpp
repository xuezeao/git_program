...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_first_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 17, 21)
    ...
    "first\0page1Exit\0\0on_pushButton_clicked\0"
};
...
void first::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (first::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&first::page1Exit)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject first::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_first.data,
      qt_meta_data_first,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_first.stringdata))
