...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_second_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 18, 21)
    ...
    "second\0page2Exit\0\0on_pushButton_clicked\0"
};
...
void second::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (second::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&second::page2Exit)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject second::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_second.data,
      qt_meta_data_second,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_second.stringdata))
