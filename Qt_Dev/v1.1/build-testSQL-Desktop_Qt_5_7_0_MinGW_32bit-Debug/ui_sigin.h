...
public:
    ...
    void setupUi(QWidget *sigin)
    {
        ...
        widget->setStyleSheet(QStringLiteral("border-image:url(:/image/background2.bmp)"));
        ...
        pushButton_sigin->setFont(font2);
        pushButton_sigin->setStyleSheet(QStringLiteral("color: rgb(255, 255, 255);"));
